...
class TicTacToe:
    def __init__(self, game):
        ...
        self.field_image = self.get_scaled_image(path='../Assets/TicTacToe/field.png', res=[WIN_SIZE] * 2)
        self.O_image = self.get_scaled_image(path='../Assets/TicTacToe/o.png', res=[CELL_SIZE] * 2)
        self.X_image = self.get_scaled_image(path='../Assets/TicTacToe/x.png', res=[CELL_SIZE] * 2)
    ...
    def check_winner(self):
        for line_indices in self.line_indices_array:
            ...
            if sum_line in {0, 3}:
                ...
                if self.winner == self.human_symbol:  #Ha a játékos nyert növeljük a győzelmek számát
